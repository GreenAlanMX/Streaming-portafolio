#!/usr/bin/env python3
"""
Memory-Fixed Performance Benchmark for ETL Pipeline
==================================================
Correctly measures memory usage by monitoring the ETL subprocess.
"""
...
class MemoryFixedBenchmark:
    """Benchmarking class with correct memory measurement"""
...
"""
    ...
    def run_all_benchmarks(self) -> None:
        ...
        logger.info("Starting memory-fixed performance benchmarking")
    ...
    def save_results(self) -> None:
        ...
        output_file = self.output_dir / "memory_fixed_benchmark_results.csv"
    ...
    def generate_performance_plots(self) -> None:
        ...
        fig.suptitle('ETL Pipeline Performance Analysis (Memory Fixed)', fontsize=16, fontweight='bold')
        ...
        axes[1, 0].set_title('Memory Usage vs Data Size (Fixed)')
        ...
        # Save plot
        plot_file = self.output_dir / "memory_fixed_performance_analysis.png"
...
def main():
    """Main function to run the memory-fixed benchmark"""
    benchmark = MemoryFixedBenchmark()
    ...
    try:
        ...
        logger.info("Memory-fixed benchmarking completed successfully!")
