#!/usr/bin/env python3
"""
Final Performance Benchmark for ETL Pipeline
===========================================
Correctly measures memory usage by monitoring the ETL subprocess using psutil.
"""
...
class MemoryMonitor:
    """Monitor memory usage of a subprocess using psutil"""
    ...
    def stop_monitoring(self):
        ...
        return max(self.memory_samples), sum(self.memory_samples) / len(self.memory_samples)
    
    def _monitor_loop(self):
        """Monitor loop running in separate thread"""
        while self.running:
            try:
                # Get memory info for the subprocess using psutil
...
class FinalBenchmark:
    """Final benchmarking class with correct memory measurement"""
...
"""
    ...
    def run_etl_benchmark(self, size_name: str, size_config: Dict[str, int]) -> BenchmarkResult:
        """Run ETL pipeline and measure performance with correct memory monitoring"""
        ...
        try:
            ...
            # Start memory monitoring using the process PID
            ...
            memory_peak, memory_avg = monitor.stop_monitoring()
            ...
            logger.info(f"Memory peak: {memory_peak:.2f} MB, Memory avg: {memory_avg:.2f} MB")
    ...
    def run_all_benchmarks(self) -> None:
        ...
        logger.info("Starting final performance benchmarking")
    ...
    def save_results(self) -> None:
        ...
        for result in self.results:
            data.append({
                ...
                'memory_avg_mb': result.memory_avg,
        ...
        output_file = self.output_dir / "final_benchmark_results.csv"
    ...
    def generate_performance_plots(self) -> None:
        ...
        fig.suptitle('ETL Pipeline Performance Analysis (Final)', fontsize=16, fontweight='bold')
        ...
        axes[1, 0].set_title('Memory Usage vs Data Size (Corrected)')
        ...
        # Save plot
        plot_file = self.output_dir / "final_performance_analysis.png"
...
def main():
    """Main function to run the final benchmark"""
    ...
    try:
        ...
        logger.info("Final benchmarking completed successfully!")
