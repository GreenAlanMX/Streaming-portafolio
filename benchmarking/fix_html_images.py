#!/usr/bin/env python3
"""
Fix HTML Images by Embedding Base64
==================================
Converts images to base64 and embeds them directly in the HTML report.
"""
...
def create_html_with_embedded_images():
    ...
    images = {
        'enhanced': image_to_base64("benchmarking/results/enhanced_performance_analysis.png"),
        'memory': image_to_base64("benchmarking/results/memory_analysis_detailed.png"),
        'scalability': image_to_base64("benchmarking/results/scalability_analysis.png")
    }
...
<body>
    <div class="container">
        ...
        <div class="plot-container">
            ...
            <img src="{images['memory']}" alt="Memory Analysis Detailed">
            <div class="plot-description">
...
"""
    ...
    # Save HTML report with embedded images
    output_file = Path("benchmarking/results/benchmark_report_with_images.html")
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print(f"✅ HTML report with embedded images generated: {output_file}")
    return output_file

if __name__ == "__main__":
    create_html_with_embedded_images()
